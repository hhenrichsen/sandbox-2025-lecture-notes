...
- Greedy Algorithms<!-- .element: class="fragment fade-in-then-semi-out" -->
- Dynamic Programming (and
  Backtracking)<!-- .element: class="fragment fade-in-then-semi-out" -->
- Divide and Conquer<!-- .element: class="fragment fade-in-then-semi-out" -->
- Priority Queues<!-- .element: class="fragment fade-in-then-semi-out" -->
- Arrays (Binary Search, Sliding Window, Prefix
  Sum)<!-- .element: class="fragment fade-in-then-semi-out" -->
- Trees (DFS, BFS,
  Tries)<!-- .element: class="fragment fade-in-then-semi-out" -->
- Graphs (DFS, BFS, Union Find, Topological
  Sort)<!-- .element: class="fragment fade-in-then-semi-out" -->
- Linear Programming<!-- .element: class="fragment fade-in-then-semi-out" -->
...
types of interviews, but it's not worth grinding LeetCode constantly once you
know the pattern. I find Advent of Code and similar events can be really good
ways to brush up on these, especially the past years.
...
functionality. Some of these will get into scaling, data storage, caching,
reliability, observability, etc. though those tend to be for more
infrastructure-oriented or senior roles.
...
I think in general, teams should be small. I think about 6 engineers is the max
before a team starts running into issues, and below 3 it's not really a team.
