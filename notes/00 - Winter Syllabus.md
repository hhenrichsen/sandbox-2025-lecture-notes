...
#### Continuous Integration (10pts / 10%)

**Due**: January 30th, 2026

Record a brief demo of how you automatically check your app for issues when a
pull request is opened or updated. This process must be automatic and show at
least two different quality checks (some examples: linting, formatting,
automated tests, dependency scanning).

**Point Breakdown**:

- 5pts for each automated quality check on PR creation / push, up to 10pts

<!-- vslide -->

#### Continuous Delivery (10pts / 10%)

**Due**: February 27th, 2026

Record a brief demo of how your app makes it from being pushed to your main
branch to deployed in production. This process must be automatic in order for it
to count.

**Point Breakdown**:

- 5pts for a process to deploy things from main to production
- 5pts for process automation

<!-- vslide -->

#### Observability (10pts / 10%)

**Due**: March 27th, 2026

Show me how you collect information when something isn't going wrong. Logs,
error tracing, and product metrics all count here. Show me at least one tool. My
recommendations are Sentry, PostHog, Grafana, and Prometheus, though other tools
exist.
...
- Give a Tech Talk (5 points)
- Ask questions in class (1 point)
- Come in for office hours outside of check-ins (1 point)
- Talk about news at the beginning of class (1 point)
- Submit topics to the Q&A sessions (1 point)
